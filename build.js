...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 600px) {
    ...
    .creds-bar { width: 100%; overflow-x: auto; overflow-y: hidden; overscroll-behavior-x: contain; -webkit-overflow-scrolling: touch; scrollbar-width: thin; scroll-snap-type: x proximity; }
    .creds-track { width: max-content; display: flex; gap: 0; padding: .75rem 0; animation: none !important; transform: none !important; }
    .cred-pill { min-width: max-content; scroll-snap-align: start; white-space: nowrap; padding: .25rem 1rem; border-right: 1px solid rgba(28,43,58,.18); font-size: .68rem; line-height: 1.25; }
  }
