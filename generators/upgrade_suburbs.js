  ...
  <section style="background:var(--white);">
    <div class="container">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: start;">
        <div>
          <div class="section-eyebrow">Local Expert: ${sub.name}</div>
          <h2 class="display">Compliance in the heart of <em>${sub.name}</em></h2>
          <p class="body-lead">Navigating the local council regulations around ${sub.landmark} requires more than just generic templates. AMES Food Advisory brings 11+ years of Tier-1 manufacturing experience and real-world TAFE NSW lecturing expertise directly to the food businesses of ${sub.name}.</p>
          
          <p style="margin-bottom: 2rem; color: var(--ink-mid); max-width: 800px; line-height: 1.8;">
            Whether you run a fast-paced cafe, an artisanal bakery, or a massive commercial kitchen, our customized systems are designed specifically for the ${sub.region} landscape. We are the <strong>Expert Coaches</strong> who help you win against the "Judges" (Auditors and Council EHOs).
          </p>
          ...
          <div class="includes-grid">
              <div class="include-item">
                ...
                <div>
                  <div class="include-title">${sub.region} Council Audit Prep</div>
                  <div class="include-desc">Mock inspections and gap analysis reports aligned specifically to local council criteria in ${sub.name}.</div>
                </div>
              </div>
              <div class="include-item">
                <div class="include-icon">📋</div>
        ...
        <div style="background: var(--navy-deep); border-radius: 12px; padding: 2.5rem; color: var(--white); margin-top: 2rem;">
          <div style="display: flex; flex-direction: column; align-items: center; text-align: center;">
            <div style="width: 80px; height: 80px; background: var(--navy-lift); border-radius: 50%; margin-bottom: 1.25rem; display: flex; align-items: center; justify-content: center; font-size: 2rem; border: 2px solid var(--amber);">👤</div>
